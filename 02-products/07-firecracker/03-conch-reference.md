...
本项目外部 UFFD 主方案的验证门槛见[核心选型计划](../../04-conch-design-reference/09-core-design-selection.md)。外部 handler 不等于必须新增 binary，也不要求合并 RAM/pmem 状态机。Issue #5740 的文件 FD/remap 思路另属提案，不能用已有 RAM 恢复文档证明正式 pmem 已支持远端按需；状态以已登记版本为限。
